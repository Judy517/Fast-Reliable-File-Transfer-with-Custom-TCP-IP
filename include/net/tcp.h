 ...
 */
// EE542 changes: #define MAX_TCP_WINDOW		32767U
#define MAX_TCP_WINDOW		65535U
...
// EE542 changes: #define TCP_FASTRETRANS_THRESH 3
#define TCP_FASTRETRANS_THRESH 1
...
// EE542 changes: #define TCP_SYN_RETRIES	 6
#define TCP_SYN_RETRIES	 5	/* This is how many retries are done
...
#endif
// EE542 changes: #define TCP_RTO_MAX	((unsigned)(120*HZ))
#define TCP_RTO_MAX	((unsigned)(3*HZ/5))
// EE542 changes: #define TCP_RTO_MIN	((unsigned)(HZ/5))
 #define TCP_RTO_MIN	((unsigned)(HZ/10))
// EE542 changes:  #define TCP_TIMEOUT_INIT ((unsigned)(1*HZ))
#define TCP_TIMEOUT_INIT ((unsigned)(HZ/5))	/* RFC6298 2.1 initial RTO value	*/
...
// EE542 changes:  #define TCPOPT_WINDOW		3
#define TCPOPT_WINDOW		6	/* Window scaling */
...
/* Flags in tp->nonagle */
// EE542 changes:  #define TCP_NAGLE_OFF		1
#define TCP_NAGLE_OFF		0	/* Nagle's algo is disabled */
...
// EE542 changes:  #define TCP_INIT_CWND		10
...
{ 
	// EE542 changes:  return usecs_to_jiffies((tp->srtt_us >> 3) + tp->rttvar_us);
	return usecs_to_jiffies(tp->srtt_us + 4*(tp->rttvar_us));
}
